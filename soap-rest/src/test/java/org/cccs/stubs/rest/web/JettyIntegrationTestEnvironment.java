...
public abstract class JettyIntegrationTestEnvironment {
    ...
    protected static MarshallingHttpMessageConverter domainObjectConverter;
    ...
    public static void runOnce() {
        ...
        domainObjectConverter = new MarshallingHttpMessageConverter(marshaller);
